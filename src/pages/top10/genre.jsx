...
const Top10Genre = () => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      setIsLoading(true);
      try {
        const moviesData = await fetchMovies('', [genre], false);
  ...
  return (
    <Background>
      <Container>
        ...
        <Subtitle>Os melhores filmes do gênero {genre}</Subtitle>
        ...
        <Footer 
          title={`Top 10 ${genre}`}
          content={`Os filmes mais populares e bem avaliados do gênero ${genre}.`}
          showDefault={false}
        />
      </Container>
    </Background>

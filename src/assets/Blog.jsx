    ...
    <Layout>
      ...
      <BlogContainer>
        ...
        <PostGrid>
          <PostCard>
            <PostContent>
              <PostTitle>25 Anos de Clube da Luta: Por Que o Soco de Tyler Durden Ainda Dói em 2025?</PostTitle>
              <PostExcerpt>
                Clube da Luta, dirigido pela mão precisa e sombria de David Fincher, chegava aos cinemas. Agora, em julho de 2025, mais de 25 anos depois, olhamos para trás e percebe...
              </PostExcerpt>
              <PostLink as={Link} to="/blog/post14">Continuar lendo...</PostLink>
            </PostContent>
          </PostCard>
          <PostCard>
            <PostContent>
              <PostTitle>M3GAN 2.0: Crítica</PostTitle>
              <PostExcerpt>
                Quando M3GAN dançou desajeitadamente ao som de Taylor Swift em 2023, ela não apenas se tornou um meme instantâneo, mas também se consolidou como um novo ícone do terr...
              </PostExcerpt>
              <PostLink as={Link} to="/blog/post13">Continuar lendo...</PostLink>
            </PostContent>
          </PostCard>
          <PostCard>
            <PostContent>
              ...
              <PostExcerpt>
              "'Ohana quer dizer família. Família quer dizer nunca abandonar ou esquecer." Poucas frases da Disney marcaram tanto uma geração quanto est...
              </PostExcerpt> 
          ...
          <PostCard>
            <PostContent>
              <PostTitle>Guia Completo dos Gêneros Cinematográficos</PostTitle>
              <PostExcerpt>
          ...
          <PostCard>
            <PostContent>
              ...
              <PostExcerpt>
              Escolher um filme para assistir pode parecer uma tarefa simples, mas quando nos deparamos com milhares de opçõ...
              </PostExcerpt>
